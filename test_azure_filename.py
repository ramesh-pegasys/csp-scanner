...
def test_azure_filename_generation():
    ...
    assert "mystorageaccount" in filename, "Resource name should be extracted from resource_id"
    assert not "unknown" in filename.split('_')[:3], "Should not have unknown in service/resource_type/resource_name"
