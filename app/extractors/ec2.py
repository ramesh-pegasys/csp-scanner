...
class EC2Extractor(BaseExtractor):
    ...
    def _extract_instances(self, client, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def _extract_security_groups(self, client, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """Extract security groups"""
        artifacts = []
        ...
        if resource_type == 'instance':
            return {
                ...
                'configuration': {
                    ...
                    'security_groups': [sg['GroupId'] for sg in resource.get('SecurityGroups', [])],
