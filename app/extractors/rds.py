...
class RDSExtractor(BaseExtractor):
    ...
    def get_metadata(self) -> ExtractorMetadata:
        return ExtractorMetadata(
            ...
            resource_types=["db-instance", "db-cluster", "db-snapshot", "db-cluster-snapshot"],
    ...
    def _extract_region(self, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        try:
            db_cluster_snapshots = self._extract_db_cluster_snapshots(rds_client, region, filters)
    ...
    def _extract_db_instances(self, client, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def _extract_db_clusters(self, client, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def _extract_db_snapshots(self, client, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    def _extract_db_cluster_snapshots(self, client, region: str, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        if resource_type == 'db-instance':
            return {
                ...
                'configuration': {
                    ...
                    'preferred_maintenance_window': resource.get('PreferredMaintenanceWindow'),
                    ...
                    'secondary_availability_zone': resource.get('SecondaryAvailabilityZone'),
                    ...
                    'auto_minor_version_upgrade': resource.get('AutoMinorVersionUpgrade'),
                    'read_replica_db_instance_identifiers': resource.get('ReadReplicaDBInstanceIdentifiers', []),
                    'read_replica_source_db_instance_identifier': resource.get('ReadReplicaSourceDBInstanceIdentifier'),
                    'replica_mode': resource.get('ReplicaMode'),
                    'license_model': resource.get('LicenseModel'),
                    'option_group_memberships': resource.get('OptionGroupMemberships', []),
                    'character_set_name': resource.get('CharacterSetName'),
            ...
            return {
                ...
                'configuration': {
                    ...
                    'tag_list': resource.get('TagList', []),
                    'global_cluster_identifier': resource.get('GlobalClusterIdentifier'),
                    ...
                    'promoted_to_global_cluster': resource.get('PromotedToGlobalCluster'),
                },
                'raw': resource
            }
            ...
            return {
                ...
                'configuration': {
                    ...
                    'source_db_snapshot_identifier': resource.get('SourceDBSnapshotIdentifier'),
                    'storage_type': resource.get('StorageType'),
                    'tde_credential_arn': resource.get('TdeCredentialArn'),
                    ...
                    'iam_database_authentication_enabled': resource.get('IAMDatabaseAuthenticationEnabled'),
            ...
            return {
                ...
                'configuration': {
                    ...
                    'source_db_cluster_snapshot_arn': resource.get('SourceDBClusterSnapshotArn'),
                    'iam_database_authentication_enabled': resource.get('IAMDatabaseAuthenticationEnabled'),
                    'tag_list': resource.get('TagList', []),
                },
                'raw': resource
